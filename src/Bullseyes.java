...
public class Bullseyes {
	...
	public static void main(String args[]) throws IOException
	{
		...
		for(int i=0; i<N; i++)
		{
			...
			//out.println("Case #"+(i+1)+": "+(long)res(rr,tt));
			out.println("Case #"+(i+1)+": "+(String.format("%.0f", res(rr,tt))));
			System.out.println("Case #"+(i+1)+": "+(String.format("%.0f", res(rr,tt)))+"("+rr+","+tt+")");
		}
	...
	public static double res(double r, double t)
	{
		double tt = t*Math.PI; 
